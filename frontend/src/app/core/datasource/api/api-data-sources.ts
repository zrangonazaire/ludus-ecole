...
export class ApiLevelDataSource implements LevelDataSource {
  ...
  get(id: string): Observable<Level> {
    return this.http.get<Level>(this.base + '/' + id);
  }
  ...
  update(id: string, payload: LevelUpsertPayload): Observable<Level> {
    return this.http.put<Level>(this.base + '/' + id, payload);
  }

  archive(id: string): Observable<Level> {
    return this.http.post<Level>(this.base + '/' + id + '/archive', {});
  }

  restore(id: string): Observable<Level> {
    return this.http.post<Level>(this.base + '/' + id + '/restore', {});
  }
}
