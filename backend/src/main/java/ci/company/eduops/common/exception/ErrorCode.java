...
public enum ErrorCode {
    ...
    CAMPUS_CODE_ALREADY_USED(HttpStatus.CONFLICT,
            "Another campus already uses this code in the school."),
    CAMPUS_IN_USE(HttpStatus.CONFLICT,
            "This campus cannot be archived: rooms are still linked to it."),
    CAMPUS_MAIN_EXISTS(HttpStatus.CONFLICT,
            "This school already has a main campus."),
    ROOM_CODE_ALREADY_USED(HttpStatus.CONFLICT,
            "Another room already uses this code in the campus."),
    BUILDING_NOT_FOUND(HttpStatus.NOT_FOUND, "Building not found."),
    BUILDING_CODE_ALREADY_USED(HttpStatus.CONFLICT,
            "Another building already uses this code in the campus."),
    BUILDING_IN_USE(HttpStatus.CONFLICT,
            "This building cannot be archived: active rooms are still linked to it."),
    ROOM_IN_USE(HttpStatus.CONFLICT,
            "This room cannot be archived: the timetable or a class still uses it."),
    ROOM_ARCHIVED(HttpStatus.CONFLICT,
            "This room is archived and cannot be booked."),
    ROOM_TYPE_INVALID(HttpStatus.BAD_REQUEST, "Unknown room type."),
    ...
    LEVEL_CODE_ALREADY_USED(HttpStatus.CONFLICT,
            "Another level already uses this code in the same cycle."),
    LEVEL_IN_USE(HttpStatus.CONFLICT,
            "This level still carries classes, a programme or applications and cannot be archived."),
    LEVEL_INVALID_NEXT_LEVEL(HttpStatus.CONFLICT,
            "The next level must belong to the same school and must not close a loop."),
