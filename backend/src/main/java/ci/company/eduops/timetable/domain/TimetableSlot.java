...
/**
 * One recurring weekly slot. Teacher, class and room overlaps are additionally
 * prevented by PostgreSQL EXCLUDE constraints, so no code path can create one.
 */
@Entity
...
public class TimetableSlot extends BaseEntity {
    ...
    private String slotType = "COURSE";
